function [echo] = GE420_serialwrite_echo(name,floatval)
%GE420_SERIALWRITE_ECHO
%   GE420_serialwrite_echo(NAME,FLOATVAL) will modify a variable on the DSP
...
%
%		myecho = GE420_serialwrite_echo('myfloat',5.5);
%
...
filename = dir('../Cheapli_SE420_cpu2/debug/*.map');

map = parseMap(strcat('../Cheapli_SE420_cpu2/debug/',filename.name))
