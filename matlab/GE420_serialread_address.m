function [out3] = GE420_serialread_address(address,varsize)
%GE420_SERIALREAD_ADDRESS
%   N = GE420_serialread_address(ADDRESS,VARSIZE) will return data from the
...
%
%		mydata = GE420_serialread_address(128432,1);
%
...
%
%		myarray = GE420_serialread('myfloatarray',1000);
%
...
filename = dir('../Cheapli_SE420_cpu2Project/debug/*.map');

map = parseMap(strcat('../Cheapli_SE420_cpu2Project/debug/',filename.name))
